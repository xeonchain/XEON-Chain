...
pkgdatadir = $(datadir)/xeonchain
pkgincludedir = $(includedir)/xeonchain
pkglibdir = $(libdir)/xeonchain
pkglibexecdir = $(libexecdir)/xeonchain
...
ACLOCAL = ${SHELL} /root/XEON/XEON/build-aux/missing aclocal-1.15
AMTAR = $${TAR-tar}
AM_DEFAULT_VERBOSITY = 0
AR = /usr/bin/ar
AUTOCONF = ${SHELL} /root/XEON/XEON/build-aux/missing autoconf
AUTOHEADER = ${SHELL} /root/XEON/XEON/build-aux/missing autoheader
AUTOMAKE = ${SHELL} /root/XEON/XEON/build-aux/missing automake-1.15
AWK = gawk
BDB_CFLAGS = 
BDB_CPPFLAGS = 
BDB_LIBS = -ldb_cxx-4.8
BITCOIN_CLI_NAME = xeonchain-cli
BITCOIN_DAEMON_NAME = xeonchaind
BITCOIN_GUI_NAME = xeonchain-qt
BITCOIN_TX_NAME = xeonchain-tx
...
COPYRIGHT_HOLDERS_FINAL = The XeonChain Core developers
COPYRIGHT_HOLDERS_SUBSTITUTION = XeonChain Core
COPYRIGHT_YEAR = 2017
CPP = gcc -E
...
MAINT = 
MAKEINFO = ${SHELL} /root/XEON/XEON/build-aux/missing makeinfo
MAKENSIS = 
MANIFEST_TOOL = :
MINIUPNPC_CPPFLAGS = 
...
OTOOL64 = 
PACKAGE = xeonchain
PACKAGE_BUGREPORT = https://github.com/xeonchain-project/xeonchain/issues
PACKAGE_NAME = XeonChain Core
PACKAGE_STRING = XeonChain Core 0.14.2
PACKAGE_TARNAME = xeonchain
PACKAGE_URL = https://xeonchain.org/
...
ZMQ_CFLAGS = 
ZMQ_LIBS = -lzmq
abs_builddir = /root/XEON/XEON
abs_srcdir = /root/XEON/XEON
abs_top_builddir = /root/XEON/XEON
abs_top_srcdir = /root/XEON/XEON
ac_ct_AR = ar
ac_ct_CC = gcc
ac_ct_CXX = g++
ac_ct_DUMPBIN = 
...
install_sh = ${SHELL} /root/XEON/XEON/build-aux/install-sh
...
OSX_APP_BUILT = $(OSX_APP)/Contents/PkgInfo $(OSX_APP)/Contents/Resources/empty.lproj \
  ...
  $(OSX_APP)/Contents/MacOS/XeonChain-Qt $(OSX_APP)/Contents/Resources/Base.lproj/InfoPlist.strings
...
$(OSX_APP)/Contents/MacOS/XeonChain-Qt: $(BITCOIN_QT_BIN)
	$(MKDIR_P) $(@D)
...
$(APP_DIST_EXTRAS): $(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/XeonChain-Qt
...
$(APP_DIST_DIR)/$(OSX_APP)/Contents/MacOS/XeonChain-Qt: $(OSX_APP_BUILT) $(OSX_PACKAGING)
