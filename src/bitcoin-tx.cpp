...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || IsArgSet("-?") || IsArgSet("-h") || IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s xeonchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  xeonchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded xeonchain transaction") + "\n" +
              "  xeonchain-tx [options] -create [commands]   " + _("Create hex-encoded xeonchain transaction") + "\n" +
              "\n";
