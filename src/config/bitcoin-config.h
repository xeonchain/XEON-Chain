...
/* Copyright holder(s) */
#define COPYRIGHT_HOLDERS_FINAL "The XeonChain Core developers"

/* Replacement for %s in copyright holders string */
#define COPYRIGHT_HOLDERS_SUBSTITUTION "XeonChain Core"
...
#define PACKAGE_BUGREPORT "https://github.com/xeonchain-project/xeonchain/issues"

/* Define to the full name of this package. */
#define PACKAGE_NAME "XeonChain Core"

/* Define to the full name and version of this package. */
#define PACKAGE_STRING "XeonChain Core 0.14.2"

/* Define to the one symbol short name of this package. */
#define PACKAGE_TARNAME "xeonchain"

/* Define to the home page for this package. */
#define PACKAGE_URL "https://xeonchain.org/"
