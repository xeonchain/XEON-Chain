...
{
    const std::string URL_SOURCE_CODE = "<https://github.com/xeonchain-project/xeonchain>";
    const std::string URL_WEBSITE = "<https://xeonchain.org>";
